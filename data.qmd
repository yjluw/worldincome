...
The World Income Inequality Database (WIID) contains information about income inequality for 201 countries. The current version released on 28 November 2023 contains over 24,000 data points with observations from pre-1960s to 2022. We plan to import this data by download the .xlse file from its website (https://www.wider.unu.edu/database/world-income-inequality-database-wiid). WIID will be regularly updated without a specific schedule. WIID combines informations from various authoritative sources including:
